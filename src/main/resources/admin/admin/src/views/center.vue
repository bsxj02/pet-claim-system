  ...
  <div :style='{"padding":"30px","margin":"0"}'>
    ...
    >  
     <el-row>
        ...
        <el-form-item :style='{"margin":"0 0 20px 0"}'   v-if="flag=='jiuzhuzhe'"  label="救助账号" prop="jiuzhuzhanghao">
          <el-input v-model="ruleForm.jiuzhuzhanghao" readonly              placeholder="救助账号" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"margin":"0 0 20px 0"}'   v-if="flag=='jiuzhuzhe'"  label="救助人名" prop="jiuzhurenming">
          <el-input v-model="ruleForm.jiuzhurenming"               placeholder="救助人名" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"margin":"0 0 20px 0"}' v-if="flag=='jiuzhuzhe'"  label="性别" prop="xingbie">
          <el-select v-model="ruleForm.xingbie"  placeholder="请选择性别">
            <el-option
        ...
        <el-form-item :style='{"margin":"0 0 20px 0"}'   v-if="flag=='jiuzhuzhe'"  label="联系电话" prop="lianxidianhua">
          <el-input v-model="ruleForm.lianxidianhua"               placeholder="联系电话" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"margin":"0 0 20px 0"}' v-if="flag=='jiuzhuzhe'" label="头像" prop="touxiang">
          <file-upload
          tip="点击上传头像"
          action="file/upload"
          :limit="3"
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
      ...
      if((!this.ruleForm.jiuzhuzhanghao)&& 'jiuzhuzhe'==this.flag){
        this.$message.error('救助账号不能为空');
        return
      }


      if((!this.ruleForm.mima)&& 'jiuzhuzhe'==this.flag){
        this.$message.error('密码不能为空');
        return
      }


      if((!this.ruleForm.jiuzhurenming)&& 'jiuzhuzhe'==this.flag){
      ...
      if( 'jiuzhuzhe' ==this.flag && this.ruleForm.lianxidianhua&&(!isMobile(this.ruleForm.lianxidianhua))){
