<template>
	<div class="addEdit-block" :style='{"padding":"30px","margin":"0"}'>
		...
		>
			<template >
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="宠物种类" prop="chongwuzhonglei">
					<el-input v-model="ruleForm.chongwuzhonglei" placeholder="宠物种类" clearable  :readonly="ro.chongwuzhonglei"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="宠物种类" prop="chongwuzhonglei">
